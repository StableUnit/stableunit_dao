...
interface ExampleOFTUpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class ExampleOFTUpgradeable extends BaseContract {
  ...
  interface: ExampleOFTUpgradeableInterface;
