...
interface NativeOFTInterface extends ethers.utils.Interface {
  functions: {
...
export type DepositEvent = TypedEvent<
  [string, BigNumber] & { _dst: string; _amount: BigNumber }
>;
...
export type WithdrawalEvent = TypedEvent<
  [string, BigNumber] & { _src: string; _amount: BigNumber }
>;

export class NativeOFT extends BaseContract {
