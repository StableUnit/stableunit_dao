...
interface CurveAdapterInterface extends ethers.utils.Interface {
  functions: {
    ...
    "registerLP(address,address,uint256,uint8)": FunctionFragment;
...
export class CurveAdapter extends BaseContract {
  ...
  interface: CurveAdapterInterface;
  ...
  functions: {
    ...
    lps(
      arg0: string,
      overrides?: CallOverrides
    ): Promise<[string, number] & { pool: string; poolType: number }>;
