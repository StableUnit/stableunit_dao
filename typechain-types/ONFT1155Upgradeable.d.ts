...
interface ONFT1155UpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class ONFT1155Upgradeable extends BaseContract {
  ...
  interface: ONFT1155UpgradeableInterface;
