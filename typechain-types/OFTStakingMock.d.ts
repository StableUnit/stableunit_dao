...
interface OFTStakingMockInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setRemoteStakingContract(uint16,bytes)": FunctionFragment;
...
export class OFTStakingMock extends BaseContract {
  ...
  interface: OFTStakingMockInterface;
