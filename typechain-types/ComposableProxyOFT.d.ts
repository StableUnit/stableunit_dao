...
interface ComposableProxyOFTInterface extends ethers.utils.Interface {
  functions: {
...
export class ComposableProxyOFT extends BaseContract {
  ...
  interface: ComposableProxyOFTInterface;
