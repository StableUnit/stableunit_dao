...
interface ONFT721UpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class ONFT721Upgradeable extends BaseContract {
  ...
  interface: ONFT721UpgradeableInterface;
