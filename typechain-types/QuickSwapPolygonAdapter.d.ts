...
interface QuickSwapPolygonAdapterInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "registerLP", values: [string]): string;
  encodeFunctionData(
...
export class QuickSwapPolygonAdapter extends BaseContract {
  ...
  interface: QuickSwapPolygonAdapterInterface;
  ...
  callStatic: {
    ...
    registerLP(lp: string, overrides?: CallOverrides): Promise<void>;
