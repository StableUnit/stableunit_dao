...
interface ComposableBasedOFTInterface extends ethers.utils.Interface {
  functions: {
...
export class ComposableBasedOFT extends BaseContract {
  ...
  interface: ComposableBasedOFTInterface;
