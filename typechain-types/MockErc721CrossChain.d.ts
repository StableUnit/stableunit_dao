...
interface MockErc721CrossChainInterface extends ethers.utils.Interface {
  functions: {
...
export class MockErc721CrossChain extends BaseContract {
  ...
  interface: MockErc721CrossChainInterface;
