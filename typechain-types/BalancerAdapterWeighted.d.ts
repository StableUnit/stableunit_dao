...
interface BalancerAdapterWeightedInterface extends ethers.utils.Interface {
  functions: {
...
export class BalancerAdapterWeighted extends BaseContract {
  ...
  interface: BalancerAdapterWeightedInterface;
