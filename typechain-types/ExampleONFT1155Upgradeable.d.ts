...
interface ExampleONFT1155UpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class ExampleONFT1155Upgradeable extends BaseContract {
  ...
  interface: ExampleONFT1155UpgradeableInterface;
