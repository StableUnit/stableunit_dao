...
interface DistributeONFT721Interface extends ethers.utils.Interface {
  functions: {
...
export class DistributeONFT721 extends BaseContract {
  ...
  interface: DistributeONFT721Interface;
