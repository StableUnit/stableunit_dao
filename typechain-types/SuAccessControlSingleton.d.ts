...
interface SuAccessControlSingletonInterface extends ethers.utils.Interface {
  functions: {
...
export class SuAccessControlSingleton extends BaseContract {
  ...
  callStatic: {
    ...
    initialize(dao: string, overrides?: CallOverrides): Promise<void>;
