...
interface ExampleONFT721UpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class ExampleONFT721Upgradeable extends BaseContract {
  ...
  interface: ExampleONFT721UpgradeableInterface;
  ...
  functions: {
    ...
    initialize(
      _name: string,
      _symbol: string,
      _minGasToTransfer: BigNumberish,
      _lzEndpoint: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
