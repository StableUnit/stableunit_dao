...
interface ComposableOFTCoreInterface extends ethers.utils.Interface {
  functions: {
...
export class ComposableOFTCore extends BaseContract {
  ...
  interface: ComposableOFTCoreInterface;
