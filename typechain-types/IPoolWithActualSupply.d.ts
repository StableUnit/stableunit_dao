...
interface IPoolWithActualSupplyInterface extends ethers.utils.Interface {
  functions: {
...
export class IPoolWithActualSupply extends BaseContract {
  ...
  interface: IPoolWithActualSupplyInterface;
