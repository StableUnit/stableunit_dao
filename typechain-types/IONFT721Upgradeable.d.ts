...
interface IONFT721UpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class IONFT721Upgradeable extends BaseContract {
  ...
  interface: IONFT721UpgradeableInterface;
