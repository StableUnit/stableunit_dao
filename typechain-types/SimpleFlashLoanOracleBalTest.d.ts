...
interface SimpleFlashLoanOracleBalTestInterface extends ethers.utils.Interface {
  functions: {
    "ORACLE()": FunctionFragment;
    "checkLPOnFlashLoanAttack(address,address,bytes32,address[],address,uint256,uint256,address)": FunctionFragment;
...
export class SimpleFlashLoanOracleBalTest extends BaseContract {
  ...
  interface: SimpleFlashLoanOracleBalTestInterface;
