...
interface ONFT1155CoreUpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class ONFT1155CoreUpgradeable extends BaseContract {
  ...
  interface: ONFT1155CoreUpgradeableInterface;
