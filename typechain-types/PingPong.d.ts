...
interface PingPongInterface extends ethers.utils.Interface {
  functions: {
    ...
    "ping(uint16,address,uint256)": FunctionFragment;
...
export type PingEvent = TypedEvent<[BigNumber] & { pings: BigNumber }>;
...
export class PingPong extends BaseContract {
  ...
  callStatic: {
    ...
    enable(en: boolean, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "Ping(uint256)"(
      pings?: null
    ): TypedEventFilter<[BigNumber], { pings: BigNumber }>;

    Ping(pings?: null): TypedEventFilter<[BigNumber], { pings: BigNumber }>;
