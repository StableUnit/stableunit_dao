...
interface PendleAdapterInterface extends ethers.utils.Interface {
  functions: {
    ...
    "registerLP(address,address,address)": FunctionFragment;
...
export class PendleAdapter extends BaseContract {
  ...
  interface: PendleAdapterInterface;
