...
interface ONFT721CoreUpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class ONFT721CoreUpgradeable extends BaseContract {
  ...
  interface: ONFT721CoreUpgradeableInterface;
