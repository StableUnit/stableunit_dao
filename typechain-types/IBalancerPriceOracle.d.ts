...
interface IBalancerPriceOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class IBalancerPriceOracle extends BaseContract {
  ...
  interface: IBalancerPriceOracleInterface;
