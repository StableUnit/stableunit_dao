...
interface ExampleUniversalONFT721Interface extends ethers.utils.Interface {
  functions: {
...
export class ExampleUniversalONFT721 extends BaseContract {
  ...
  interface: ExampleUniversalONFT721Interface;
