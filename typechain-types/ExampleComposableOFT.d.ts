...
interface ExampleComposableOFTInterface extends ethers.utils.Interface {
  functions: {
    ...
    "failedOFTReceivedMessages(uint16,bytes,uint64)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "failedOFTReceivedMessages",
    values: [BigNumberish, BytesLike, BigNumberish]
  ): string;
  encodeFunctionData(
...
export class ExampleComposableOFT extends BaseContract {
  ...
  interface: ExampleComposableOFTInterface;
