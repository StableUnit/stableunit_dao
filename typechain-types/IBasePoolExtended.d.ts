...
interface IBasePoolExtendedInterface extends ethers.utils.Interface {
  functions: {
...
export class IBasePoolExtended extends BaseContract {
  ...
  interface: IBasePoolExtendedInterface;
