...
import "../interfaces/IVeERC721Extension.sol";
 ...
 * after 1 year".
 */
contract VeERC721Extension is SuVoteToken, IVeERC721Extension {
    ERC721 public TOKEN;
    IBonus public BONUS;
    ...
    function supportsInterface(bytes4 interfaceId) public override(IERC165Upgradeable, SuVoteToken) view returns (bool) {
