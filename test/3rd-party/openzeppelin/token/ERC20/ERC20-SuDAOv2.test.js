...
const TOKEN = artifacts.require("SuDAOv2");
...
contract("ERC20", function (accounts) {
    ...
    beforeEach(async function () {
        const suDAOAddress = await stableUnitInitialize();
        this.token = await TOKEN.at(suDAOAddress);
                ...
                describe("when the spender had an approved amount", function () {
                    ...
                    it("emits an approval event", async function () {
                        expectEvent(
                            ...
                            "Approval",
                            { owner: initialHolder, spender, value: new BN(0) }
                        );
                    });
